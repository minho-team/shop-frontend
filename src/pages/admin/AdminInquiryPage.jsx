              ...
              {inquiryList.length === 0 ? (
                ...
                inquiryList.map((item) => (
                  ...
                  >
                    <td
                      style={td}
                      onClick={() => handleRowClick(item.inquiryNo)}
                    >
                      {item.inquiryNo}
                    </td>
                    <td
                    ...
                    >
                      {/* 비밀글이면 자물쇠 아이콘 표시 */}
                      {item.secretYn === "Y" && (
                        <span style={{ color: "#e00", marginRight: "6px" }}>
                          🔒
                        </span>
                      )}
                      {item.title}
                    ...
                    >
                      <span
                        style={{
                          ...
                          fontSize: "12px",
                          background:
                            item.status === "답변완료" ? "#e8f5e9" : "#fff3e0",
                          color:
                            item.status === "답변완료" ? "#2e7d32" : "#e65100",
                        }}
                      >
                        {item.status}
                      </span>
                    ...
                    <td style={td}>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleInquiryDelete(item.inquiryNo);
                        }}
                        style={{
                          background: "none",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>
                    회원번호:{" "}
                    <b style={{ color: "#222" }}>{detail.inquiry.memberNo}</b>
                  </span>
                  {/* 아이디 (JOIN으로 가져온 값) */}
                  <span>
                    아이디:{" "}
                    <b style={{ color: "#222" }}>{detail.inquiry.memberId}</b>
                  </span>
                  {/* 이름 (JOIN으로 가져온 값) */}
                  <span>
                    이름:{" "}
                    <b style={{ color: "#222" }}>{detail.inquiry.memberName}</b>
                  </span>
                </div>
              </div>
              ...
              >
                ...
                >
                  <span>
                    카테고리:{" "}
                    <b style={{ color: "#222" }}>{detail.inquiry.category}</b>
                  </span>
                  <span>
                    상태:
                    <b
                  ...
                  <span>
                    비밀글:{" "}
                    <b style={{ color: "#222" }}>
                      {detail.inquiry.secretYn === "Y" ? "🔒 비밀글" : "공개"}
                    </b>
                  </span>
                  <span>
                    조회수:{" "}
                    <b style={{ color: "#222" }}>{detail.inquiry.viewCount}</b>
                  </span>
                </div>
                {/* 등록일 (날짜 + 시간 모두 표시) */}
                <div
                ...
                >
                  ...
                  {detail.inquiry.updatedAt && (
                    <span style={{ marginLeft: "16px" }}>
                      수정일:{" "}
                      <b style={{ color: "#222" }}>
                        {formatDateTime(detail.inquiry.updatedAt)}
                      </b>
                    </span>
                  )}
                </div>
                  ...
                  {detail.comments.map((c) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            handleCommentDelete(c.inquiryCommentNo)
                          }
                          style={{
                            background: "none",
                            border: "none",
