...
import { createInquiry } from "../../api/user/inquiryApi";
...
const BoardWritePage = () => {
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...prev,
      productNo,
      category: prev.category === "배송" ? "상품/AS문의" : prev.category,
    }));
  }, [productNo]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...form,
        productNo: form.productNo ? Number(form.productNo) : null,
      };
